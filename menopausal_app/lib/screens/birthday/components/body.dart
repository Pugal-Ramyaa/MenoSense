          ...
          DefaultButton(
            ...
            press: () {
              if (_formKey.currentState!.validate()) {
                Navigator.pushNamed(context, period_date.routeName);
              }
            },
          ),
        ],
  ...
  TextFormField buildBirthdayFormField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        errorText: errors.contains(kBirthdayNullError) || errors.contains(kInvalidBirthdayError)
        ...
        focusedBorder: OutlineInputBorder(
          borderSide: BorderSide(
            color: errors.contains(kBirthdayNullError) || errors.contains(kInvalidBirthdayError)
                ? Colors.red
                : kPrimaryColor,
          ),
        ),
